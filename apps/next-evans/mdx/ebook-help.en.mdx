...
description:
  ...
  about our e-Book formats: EPUB and MOBI, and which one is best for you – plus find
  recommendations on which apps to use to read these e-books. All books are also available
  in paperback format at very low cost, and a growing number are available as audiobooks.'
---
