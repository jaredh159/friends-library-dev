...
final class ContactFormTests: AppTestCase {
  ...
  func testSubmitContactFormEnglish() async throws {
    ...
    XCTAssertContains(email?.html, "Name: Bob Villa")
    XCTAssertContains(email?.html, "Message: hey there")
    XCTAssertContains(email?.html, "Type: Website / technical question")
  ...
  func testSubmitContactFormSpanish() async throws {
    ...
    XCTAssertContains(email?.html, "Name: Pablo Smith")
    XCTAssertContains(email?.html, "Message: hola")
