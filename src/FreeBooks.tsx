...
const FreeBooks: React.FC<Props> = ({ lang }) => {
  return (
    <div className="youtube-poster">
      ...
      >
        <h1 className="text-7xl tracking-wider">Download this book for free</h1>
        <p className="text-3xl antialiased text-center opacity-90 leading-loose">
          This entire book (plus 130+ more) can be downloaded from our website for free as
          a PDF or E-Book. The audiobook is also available to be downloaded as MP3s or in
          our free iOS and Android apps. See the links in the description below.
        </p>
